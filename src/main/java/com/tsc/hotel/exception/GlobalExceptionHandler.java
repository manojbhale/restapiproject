...
import com.tsc.hotel.exception.error.ApiErrors;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleHotelNotFoundException(HotelNotFoundException ex) {
		...
		List<String> details = new ArrayList<>();
		details.add("Hotel Not FoundException...");
	...
	public ResponseEntity<Object> handleHotelNotFoundException(HotelIdNotFoundException ex) {
		String message = ex.getMessage();

		List<String> details = new ArrayList<>();
		details.add("HotelId Not FoundException...");
